...
[![go](https://img.shields.io/badge/go-1.27.0%2B-blue.svg)](go.mod)
...
- [docs/evaluation.md](docs/evaluation.md) — retrieval datasets, baselines, comparison, and regression gates.
